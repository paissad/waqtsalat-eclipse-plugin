...
/**
 * This is the item provider adapter for a {@link net.paissad.waqtsalat.locationsprovider.api.Coordinates} object. <!--
...
public class CoordinatesItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
    ...
    /**
     * This adds a property descriptor for the Latitude feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    protected void addLatitudePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getResourceLocator(),
                getString("_UI_Coordinates_latitude_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_Coordinates_latitude_feature",
                        "_UI_Coordinates_type"), LocationsProviderPackage.Literals.COORDINATES__LATITUDE, true, false,
                false, ItemPropertyDescriptor.REAL_VALUE_IMAGE, null, null));
    }

    /**
     * This adds a property descriptor for the Longitude feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    protected void addLongitudePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                getResourceLocator(),
                getString("_UI_Coordinates_longitude_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_Coordinates_longitude_feature",
                        "_UI_Coordinates_type"), LocationsProviderPackage.Literals.COORDINATES__LONGITUDE, true, false,
                false, ItemPropertyDescriptor.REAL_VALUE_IMAGE, null, null));
    }

    /**
     * This returns Coordinates.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    @Override
    ...
    public String getText(Object object) {
        ...
        return getString("_UI_Coordinates_type") + " " + coordinates.getLatitude();
    }
